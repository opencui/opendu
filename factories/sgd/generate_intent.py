...
class SgdDataset:
    def __init__(self, input, output,
                 stop_word_path,  # output path to save generated intent model openai_examples'
                 ...
                 negative_proportions=1.0,  # 'how many negative openai_examples to generate for each positive example'
...
if __name__ == '__main__':
    ...
    # now we can create intent openai_examples.
